                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card>
                    ...
                    <Form {...adCopyForm}>
                      <form onSubmit={adCopyForm.handleSubmit(onAdCopySubmit)}>
                        ...
                        <CardFooter>
                          <Button type="submit" disabled={adCopyState.loading} className="w-full">
                  ...
                  <Card className="flex flex-col">
                    <CardHeader>
                      ...
                      <CardDescription>Review and copy the generated ad content.</CardDescription>
                    </CardHeader>
                        ...
                        <div className="space-y-4">
                          {adCopyState.result.adCopyVariations.map((variation, index) => (
                            <Card key={index} className="bg-secondary/50">
                              ...
                              <CardContent><p className="text-sm">{variation}</p></CardContent>
                            </Card>
                          ))}
                        </div>
                      )}
                 ...
                 <div className="grid md:grid-cols-2 gap-8">
                    <Card>
                      ...
                      <form onSubmit={socialMediaForm.handleSubmit(onSocialMediaSubmit)}>
                        ...
                        <CardFooter>
                          <Button type="submit" disabled={socialMediaState.loading} className="w-full">
                    ...
                    <Card className="flex flex-col">
                      ...
                      <CardContent className="flex-1">
                        {socialMediaState.loading && <Skeleton className="h-48 w-full" />}
                 ...
                 <div className="grid md:grid-cols-2 gap-8">
                    <Card>
                      ...
                      <form onSubmit={seoForm.handleSubmit(onSeoSubmit)}>
                        ...
                        <CardFooter>
                           <Button type="submit" disabled={seoState.loading} className="w-full">
                    ...
                    <Card className="flex flex-col">
                       ...
                       <CardContent className="flex-1">
                          {seoState.loading && <Skeleton className="h-48 w-full" />}
